...
\subsection{Burying}
\label{Staking}
Some worlds may require you to "bury" some experience, items or WOR before entering. This is effectively temporarily moving these into possession of the world. If the player is to die, the staked things will fall under ownership of the world. The world then has the option to...
...
Worlds might wish to sell items for WOR, this is a grey area as it can be considered pay-to-win. This may be moderated by the ecosystem as worlds have the option to deny items that are issued by certain worlds.\\
