...
It's possible that worlds may require neighboring worlds to employ a \textit{world economic cap}. This sets are hard cap to the amount of resources that can be distributed to players from the environment.
