...
\tikzset{myblock/.style = {rectangle, draw, minimum height=1cm, minimum width=1cm}}
\begin{center}
\begin{tikzpicture}
    \node (WE)[myblock]{Worlds Engine};
    \node (WS)[myblock,right of=WE, yshift=2cm]{Worlds Server};
    \draw[->] (WE) -| (WS);
    % more arrows here
\end{tikzpicture}
\end{center}
