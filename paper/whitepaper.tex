...
\label{IL}
Worlds with more security requirements might require and item ledger. An item ledger is a data construct the holds the history of an item. The implementation and purpose are almost identical to an action ledger. To own an item, a plyer must own the most recent item ledger and for the hash to be verified by the world the player current resides.
...
\label{ER}
Exchanges rates are a possible alternative to world economic caps. During a world transfer players would have the option to exchange their funds into the currency of the world they are entering.
